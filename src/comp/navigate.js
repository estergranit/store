//from https://mui.com/material-ui/react-app-bar/#app-bar-with-responsive-menu
...
const ResponsiveAppBar = () => {
  ...
  //miryam****
  //work but there is an error in the console
  let productName
  function searchProductByName() {
    ...
    if (searchProduct && searchProduct.name)
      ...
      navigate(`/product-detail/${searchProduct.name}`)
      return
  }
  //-------------------------------------------------------------------------------------------------
